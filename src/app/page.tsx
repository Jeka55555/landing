...
export default function Home() {
  return (
    <>
      <div className="w-screen h-screen p-[40px] mt-[100px] ">
        <div className="flex flex-col  justify-center items-center h-full w-full gap-[40px] p-[40px]">
          <LeaderShipConteiner
            iconLink1={"/Andrey.jpg"}
            title={
        ...
        <div className="flex flex-col justify-center items-center h-full w-full gap-[40px] ">
          <InfoBoxConteiner
        ...
        <div className="flex flex-col md:flex-row justify-center items-center h-full w-full gap-[40px] md:gap-[20px]">
          <OurWorkConteiner
